...
public class Problem3_Client {
    ...
    public Problem3_Client(String serverName, int port) throws UnknownHostException, IOException {
        this.port = port;
    ...
    public static void main(String args[]) throws UnknownHostException, IOException, ClassNotFoundException {
        Problem3_Client client = new Problem3_Client("localhost", 7777);
        client.exec();
    }
}
